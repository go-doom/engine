...
// voiceOperators holds the operator numbers used by each of the nine OPL
// voices (voice_operators[2][OPL_NUM_VOICES] in i_oplmusic.c).
var voiceOperators = [2][numVoices]int{
	{0x00, 0x01, 0x02, 0x08, 0x09, 0x0a, 0x10, 0x11, 0x12},
	{0x03, 0x04, 0x05, 0x0b, 0x0c, 0x0d, 0x13, 0x14, 0x15},
}

// frequencyCurve maps a frequency index to an OPL F-number (frequency_curve[]
// in i_oplmusic.c). The final value is a deliberate buffer over-run preserved
// from the original DMX table.
var frequencyCurve = [...]uint16{
...
// volumeMappingTable maps a MIDI volume level to an OPL level value
// (volume_mapping_table[] in i_oplmusic.c).
var volumeMappingTable = [...]uint{
	0, 1, 3, 5, 6, 8, 10, 11,
